    ...
    return (
        <div>
            <div className="p-4 space-y-3 mb-6">
                ...
                <button className="btn btn-outline w-full text-">
                    <FcGoogle />
                    Login With Google
                </button>
            ...
            <div className="p-4 mb-6">
                ...
                <a className="flex items-center gap-2 rounded-t-md border border-gray-300 p-4" href="">
                ...
                <a className=" flex gap-3 items-center border-x border-gray-300 p-4" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <rect width="30" height="30" rx="15" fill="#F3F3F3" />
                ...
                <a className=" flex gap-3 items-center border rounded-b-md border-gray-300 p-4 " href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <rect width="30" height="30" rx="15" fill="#F3F3F3" />
