...
const NewsCard = ({ news }) => {
    ...
    return (
        <div className="border border-gray-200 space-y-4 rounded-md" >
            <div className="md:flex  justify-between bg-[#F3F3F3] px-4 py-2">
                <div className="flex gap-2 ">
                    <img className="rounded-full w-12" src={author.img} alt="" />
                    <div>
                        <h3 className="text-xl font-semi-bold">{author.name}</h3>
            ...
            <div className="p-4 space-y-4">
                ...
                {details.length > 200 ? <p>{details.slice(0, 200)}...... <Link
                    to={`/news/${_id}`}
                    className="block text-orange-400 mt-2 font-semibold">Read More...</Link></p>
                    : <p>{details}</p>
                }
